...
#     try:
#         # Initialize a Selenium WebDriver (you need to install a WebDriver for your browser)
...
#
#         # Define the class attribute value of the <div> elements you want to target
#         desired_div_class = 'gallery-container'
#
#         # Find all <div> elements with the specified class attribute
#         div_elements = soup.find_all('div', class_=desired_div_class)
#
#         # Initialize a list to store all extracted image links
#         all_image_links = []
#
#         # Loop through the selected <div> elements
#         for div_element in div_elements:
#             # Find all <img> tags within the current <div> element
#             img_tags = div_element.find_all('img')
#
#             # Extract the source (src) attribute from each image tag and add it to the all_image_links list
#             for img_tag in img_tags:
#                 if 'src' in img_tag.attrs:
#                     all_image_links.append(img_tag['src'])
#
#         # Close the Selenium WebDriver
#         driver.quit()
#
#         # Return the extracted image links
...
#
# # Example usage:
# url = 'https://www.trendyol.com/arzum/ar1032-shake-n-take-siyah-kisisel-300-w-smoothie-blender-p-1136728?boutiqueId=61&merchantId=105330'
